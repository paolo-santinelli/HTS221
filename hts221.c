...
int16_t hst221ReadId(i2c_transaction *i2cTrans, uint8_t * id)
{
	int16_t retVal;
...
int16_t hst221ReadParams(i2c_transaction *i2cTrans,  calib_params * params)
{
	int16_t retVal = 0;
...
{
	int16_t retVal = 0;	// Return -1 in case of error, else 0
	int16_t T_out;
	int16_t H_T_out;
	int32_t tmp32;
